...
# GGUF nodes used by your workflow
...
RUN wget -O /comfyui/models/clip/Qwen2.5-VL-7B-Instruct-abliterated.Q8_0.gguf \
    ...
    && cp /comfyui/models/clip/Qwen2.5-VL-7B-Instruct-abliterated.Q8_0.gguf /comfyui/models/text_encoders/Qwen2.5-VL-7B-Instruct-abliterated.Q8_0.gguf
